...
public class MyByteSource implements ByteSource, Serializable {
	 ...
	 *
	 * @param file
	 *            the file from which to acquire bytes.
	 * @since 1.1
	 */
	 ...
	 *
	 * @param stream
	 *            the stream from which to acquire bytes.
	 * @since 1.1
	 */
	...
	/**
	 * Returns {@code true} if the specified object is a recognized data type
	 * that can be easily converted to bytes by instances of this class,
	 ...
	 *
	 * @param o
	 *            the object to test to see if it can be easily converted to
	 *            bytes by instances of this class.
